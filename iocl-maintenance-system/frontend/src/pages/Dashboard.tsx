...
const Dashboard = () => {
  ...
  // Store prediction per pump (key = pump.id)
  ...
  // -------------------- PREDICT FAILURE --------------------
  const handlePredictFailure = async (pump: Pump) => {
    try {
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {pumps.map((pump) => {
              const prediction = predictions[pump.id];
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <p className="text-xs text-gray-500">Pump ID: {pump.id}</p>
                    <span
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <button
                      ...
                      onClick={() => handlePredictFailure(pump)}
                    >
                      Predict Failure
                    </button>
                    ...
                    {prediction && (
                      <div className="mt-3 p-3 rounded-lg border bg-gray-50">
                        <p className="font-semibold">⚙️ AI Prediction</p>
